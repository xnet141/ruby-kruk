...
# my_l2.call "test" # лямбда нужно передавать то кол-во, что ожидается
...
p = proc do
  ...
  return 42 # внутри вызова произошел return, так как return в процедуре, то мы вышли и из метода (в контексте которого вызывалась процедура) и из всей программы 
end
